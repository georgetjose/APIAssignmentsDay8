...
public class RESTAssuredBase extends PreAndTest{
	...
	public static Response postWithBodyAsStringAndUrl(String body, String URL) {
	...
	public static Response patchWithBodyAsStringAndUrl(String body, String URL) {
		
		return setLogs()
				.body(body)
				.patch(URL);
	}
	public static Response patchWithBodyAsFileAndUrl(File bodyFile, String URL) {
